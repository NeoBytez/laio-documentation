...
export default [
  ...
  {
    path: '/',
    component: ComponentCreator('/', '5e3'),
    routes: [
      {
        path: '/',
        component: ComponentCreator('/', '92e'),
        routes: [
          {
            path: '/',
            ...
            routes: [
              ...
              },
              {
                ...
                component: ComponentCreator('/Laio/common/Saving/', '4bb'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/LaioEditor/TemplateEditor/', '965'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
